...
# Вопросы по теме
## 1. Можно ли в .gitignore добавлять сразу несколько изображений? Если да то как? 
## 2. Почему жирным и курсивом нельзя выделить слова в маркированном списке? Если можно то как?
